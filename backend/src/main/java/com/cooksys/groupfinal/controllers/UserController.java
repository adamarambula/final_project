...
public class UserController {
	...
	public ProjectDto updateProject(@PathVariable Long userId, @PathVariable Long teamId, @PathVariable Long projectId, @RequestBody ProjectRequestUpdateDto projectRequestUpdateDto) {
		return userService.updateProject(userId, teamId, projectId, projectRequestUpdateDto);
	}
}
