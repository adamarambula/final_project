...
public class CompanyServiceImpl implements CompanyService {
	...
	@Override
	public ProjectDto updateProject(Long companyId, Long teamId, Long projectsId, ProjectRequestUpdateDto projectRequestUpdateDto) {
		Company company = findCompany(companyId);
		Team team = findTeam(teamId);
		...
		if (projectRequestUpdateDto == null) {
			throw new BadRequestException("Request is empty.");
		}
		if (!(projectRequestUpdateDto.getName() == null)) {
			project.setName(projectRequestUpdateDto.getName());
		}
		if (!(projectRequestUpdateDto.getDescription() == null)) {
			project.setDescription(projectRequestUpdateDto.getDescription());
		}
		if (projectRequestUpdateDto.getActive() != null) {
			project.setActive(projectRequestUpdateDto.getActive());
		}
